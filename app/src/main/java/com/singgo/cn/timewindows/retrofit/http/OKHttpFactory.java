...
import com.singgo.cn.timewindows.retrofit.http.interceptor.OnOffLineCachedInterceptor;
import com.singgo.cn.timewindows.retrofit.http.interceptor.UserAgentInterceptor;
...
enum OKHttpFactory {
    ...
    OKHttpFactory() {
       ...
       // interceptor.setLevel(HttpLoggingInterceptorM.Level.BODY);
        ...
        Cache cache = new Cache(new File(BaseApplication.cachePath), 10 * 1024 * 1024);
